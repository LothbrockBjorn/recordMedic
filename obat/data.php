		...
		<table class="table table-striped table-bordered tabl-hover">
			...
			<tbody>
				...
				if ($_SERVER['REQUEST_METHOD'] == "POST") {
					...
					$sql_obat = mysqli_query($con, $query) or die (mysql_error($con));
						...
						while($data = mysqli_fetch_array($sql_obat)){ ?>
							<tr>
								...
								<td class="text-center">
									...
									<a href="del.php?id=<?=$data['id_obat'];?>" onclick="return confirm('Yakin akan menghapus data ini?')"class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
								</td>
							</tr>
							<?php
						}
